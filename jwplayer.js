    ...
    n = {
        ...
        const l = {
          ...
          f = function (e, t) {
            ...
            t &&
              ...
              ("boolean" == typeof t.mute && (h.mute = t.mute), delete t.mute);
            const p = Object.assign(
              {},
              h,
              null == (f = window) || null == (D = f.jwplayer)
                ? void 0
                : D.defaults,
              t,
              e
            ...
            const g = p.forceLocalizationDefaults ? l.language : (0, c.G3)(),
              m = (0, c.tK)(p.intl);
            p.localization = (0, c.Mh)(a.Z, (0, c.Pm)(p, m, g));
            const C = Object.assign({}, l, p);
            "." === C.base && (C.base = (0, u.getScriptPath)("jwplayer.js")),
              (C.base = (C.base || (0, u.loadFrom)()).replace(/\/?$/, "/")),
              (n.p = C.base),
              (C.width = (0, r.a)(C.width)),
              (C.height = (0, r.a)(C.height)),
              (C.aspectratio = (0, r.R)(C.aspectratio, C.width)),
            ...
            y && (C.item = y), (0, o.hj)(C.item) || (C.item = 0);
            const F = p.autoPause;
            F &&
              (C.autoPause.viewability =
                !("viewability" in F) || Boolean(F.viewability));
            ...
            let A = C.liveTimeout;
            null !== A &&
              ((0, o.qh)(A) ? 0 !== A && (A = Math.max(30, A)) : (A = null),
              (C.liveTimeout = A));
      ...
      623: (e, t, n) => {
        ...
        const P = function (e) {
          ...
          x = (e) => {
            ...
            if (n && n.code === k.u5) {
              ...
              if (n > 0 && n < 4 && e && r.duration() > -u) {
                return new y.ZP(`//content.jwplatform.com/libraries/${e}.js`)
                  .load()
                  .then(() => {
          ...
          _ = (e, t) => {
            const n = [x(e)];
            return S(e) || n.push(Promise.resolve()), Promise.all(n);
          },
          T = (e, t) =>
            (function (e, t) {
              return n
          ...
          I = (e, t) => {
            ...
            return (0, j.Z)() ? T(e, t).then(n).catch(n) : n();
          },
          N = function (e) {
            const { attributes: t } = e,
              { language: n, base: r, setupConfig: u, intl: i } = t,
              o = (0, F.Pm)(u, i, n);
            return !(0, F.q2)(n) || (0, F.dl)(o)
              ? Promise.resolve()
              : new Promise((u) =>
                  (0, F.Dq)(r, n)
                    .then(({ response: n }) => {
          ...
          Z = (e) =>
            new Promise((t) => {
              ...
              return null != n && n.length ? (0, E.T2)(n, t) : t();
            });
        var L = n(3642);
        const M = function (e) {
          let t;
          ...
          getAllItems() {
            return this.items.reduce((e, t) => {
              ...
              return (
                n &&
                  (e[t] =
                    "captions" !== t ? (0, V.serialize)(n) : JSON.parse(n)),
                e
              );
            }, {});
          }
        ...
        const te = U.Z.logger.child("jwplayer/api/core-shim"),
          ne = function (e, t) {
            t &&
              t.code &&
              (t.sourceError && te.error(t.sourceError),
          ...
          init(e, t) {
            ...
            let a = (0, J.Z)();
            {
              n.get("backgroundLoading") ||
                (a = (0, Y.Z)(a.getPrimedElement(), a));
              const e = (this.primeUi = new ee.ZP(
                (0, ee.GU)(this.originalContainer)
              ).once("gesture", () => {
                a.prime(), this.preload(), e.destroy();
              }));
            }
            return (
              n.on("change:errorEvent", ne),
              this.setup
                .start(t)
                .then((e) => {
                  const u = e.core;
                  ...
                  this.setup &&
                    (function (e, t, n) {
                      Promise.resolve().then(() => {
                        ...
                        (r.message =
                          r.message || u.get("localization").errors[r.key]),
                          delete r.key;
                        ...
                        if (!i) {
                          ...
                          X.Z.cloneIcon &&
                            t
                              ...
                              .appendChild(X.Z.cloneIcon("error")),
                            ue(e, t);
                        }
                        u.set("errorEvent", r),
                          u.set("state", m.Vy),
          ...
          playerDestroy() {
            this.destroy && this.destroy(),
              ...
              this.currentContainer !== this.originalContainer &&
                ue(this, this.originalContainer),
              this.off(),
              (this._events =
                this._model =
                this.modelShim =
      ...
      7411: (e, t, n) => {
        ...
        n.d(t, { Z: () => a });
        var r = n(5004);
        const u = window.performance || { timing: {} },
      ...
      8348: (e, t, n) => {
        "use strict";
        n.r(t), n.d(t, { Browser: () => a, Features: () => l, OS: () => c });
        var r = n(2268);
        const u = (e, t) => {
          const n = e.exec(t);
              ...
              return ((e, t) => {
                ...
                if (e.windows)
                  ...
                  e.android
                    ...
                    : e.mac
                    ? (n = u(/Mac OS X ([._\d]+)/, t))
                    : e.tizen && (n = u(/Tizen ([._\d]+)/, t));
                if (n) {
                  r = parseInt(n, 10);
                  const e = n.split(/[._]/);
                  e && (i = parseInt(e[1], 10));
                }
                return { version: n, major: r, minor: i };
              })(this, o);
            },
          },
          l = {
      ...
      6769: (e, t, n) => {
        ...
        const i = (e) => {
            ...
            for (let n = 0; n < (0, r.my)(e); n++) {
              ...
              "jwplayer" === u.prefix &&
                "mediatypes" === (0, r.r1)(u).toLowerCase() &&
                t.push((0, r.dZ)(u));
            }
            return t;
          },
              ...
              if ("media" === c.prefix) {
                ...
                switch ((0, r.r1)(c).toLowerCase()) {
                  case "content":
                    if (
                      ((0, u.Dc)(c, "duration") &&
                        (t.duration = (0, u.m9)((0, u.Dc)(c, "duration"))),
                      (0, u.Dc)(c, "url"))
                    ) {
                      t.sources || (t.sources = []);
                      const e = {
                  ...
                  case "group":
                    ...
                    break;
                  case "subtitle": {
                    const e = { file: (0, u.Dc)(c, "url"), kind: "captions" };
                    (0, u.Dc)(c, "lang").length > 0 &&
                      (e.label = o((0, u.Dc)(c, "lang"))),
                      n.push(e);
                    break;
                  }
                }
      ...
      393: (e, t, n) => {
        ...
        const u = ["captions", "metadata", "thumbnails", "chapters"],
          i = function (e) {
            ...
            return (
              (t.kind =
                ((n = t.kind), -1 !== u.indexOf(n) ? t.kind : "captions")),
            ...
            n = function (n) {
              try {
                ...
                if (t) {
                  ...
                  if (
                    (s && "xml" === (0, u.r1)(s) && (s = s.nextSibling),
                    s && "rss" === (0, u.r1)(s))
                  ) {
                    const e = (0, i.Z)(s);
                    ...
                    .map((o) => {
                      ...
                      return t
                        ...
                        .catch(
                          (e) => (
                            t.removePlugin(o),
                            e.code ? e : new r.rG(null, (0, u.bX)(o), e)
                          )
                        );
                    })
                )
        ...
        const a = new (class {
          ...
          l = async (e, t, n) => {
            ...
            if (i)
              return (
                n.utils.logger.warn(
                  `'jwplayer/plugins/model JW Plugin "${r}" already loaded from "${i.url}". Ignoring "${e}."`
                ),
                (0, u.MK)(i, t, n)
              );
            let o = e;
            return (
              r === e && (o = e),
              a.setupPlugin(o).then((e) => (0, u.MK)(e, t, n))
            );
          };
        function d(e, t) {
            ...
            sendMediaType(e) {
              const { type: t, mimeType: n } = e[0],
                u =
                  ...
                  "mpeg" === t ||
                  (n && 0 === n.indexOf("audio/"));
              this.trigger(r.oZ, { mediaType: u ? "audio" : "video" });
            },
            getDuration: () => 0,
            trigger: i,
          };
      ...
      1384: (e, t, n) => {
        ...
        const s = () => o,
          ...
          c = function (e, t, n) {
            (o = n), e.trigger(r.h7, { target: t.target, jwstate: n });
          },
          l = function (e, t) {
            (u = (t) => c(e, t, !0)),
              (i = (t) => c(e, t, !1)),
      ...
      3642: (e, t, n) => {
        ...
        class r {
          ...
          static makePromise() {
            ...
            return (n.accept = e), (n.reject = t), n;
          }
        }
        class u {
          constructor(e, t, n) {
        ...
        class o {
          static getServiceLoader(e = {}) {
            ...
            return t.jwpServices || (t.jwpServices = new o(e)), t.jwpServices;
          }
          ...
          addOverrides(e) {
            if (
              (Array.isArray(e) || "object" != typeof e || (e = [e]),
              !Array.isArray(e))
            )
              throw Error(
                "addOverrides only accepts an array of object or a single object"
              );
            for (const { name: t, client: n } of e) {
              if (!t || !n)
                throw Error(
                  "invalid entry was passed to addOverrides. Objects must have a name and a client (url)"
                );
          ...
          delOverrides(e) {
            if (
              ...
              throw Error(
                "delOverrides only accepts an array of object or a single object"
              );
            for (const { name: t } of e) {
              if (!t)
                throw Error(
                  "invalid entry was passed to delOverrides. Objects must have a name"
                );
          ...
          async getService(e, t) {
            ...
            if (this._loadingEntries.has(e)) {
              ...
              return this._makePending(new u(e, t, i)), i;
            }
            const o = r.makePromise();
            return this._doLoad(new u(e, t, o)), o;
          }
          ...
          async _registerNonLoadingService(e, t) {
            ...
            this._serviceCache.has(o) ||
              (this._serviceCache.set(o, n),
              this._maybeResolveOtherPending(e, t, u));
          }
          _maybeResolveOtherPending(e, t, n) {
            if (!this._pendingQueue.has(e)) return;
            ...
            r.length || this._pendingQueue.delete(e), i.promise.accept(t);
          }
          _makePending(e) {
            const { name: t } = e;
          ...
          _makeFetchUrl(e, t) {
            if (this._overrides.has(e)) return this._overrides.get(e);
        ...
        const c = async (e, t, n, r) => {
            ...
            a.client &&
              (u.addOverrides({ name: i, client: a.client }), delete a.client);
      ...
      6886: (e, t, n) => {
        ...
        const f = (e, t, n, r) => {
          ...
          if ("XMLHttpRequest" in window) {
            if (
              ((f = D.xhr = D.xhr || new window.XMLHttpRequest()),
              "function" == typeof D.requestFilter)
            ) {
              let t;
              try {
                t = D.requestFilter({ url: e, xhr: f });
              } catch (e) {
                return h(e, 5), f;
              }
            ...
            (f.onreadystatechange = ((e) =>
              ...
              "overrideMimeType" in f
                ? D.mimeType && f.overrideMimeType(D.mimeType)
                : (D.useDomParser = !0);
            try {
              ...
              if (i) {
                ...
                if (t || n)
                  for (let e = 0, u = i.length; e < u; e++) {
                    const u = i[e];
                    ((t && t !== u.callback && t !== u.callback._callback) ||
                      (n && n !== u.context)) &&
                      r.push(u);
                  }
      ...
      2268: (e, t, n) => {
        ...
        const r = (e) => null !== navigator.userAgent.match(e),
          ...
          p = () =>
            !r(/\sEdg\/\d+/i) && (l() || r(/trident\/.+rv:\s*11/i) || d()),
          g = () =>
            r(/safari/i) &&
          ...
          y = () =>
            !(r(/chrome\/[123456789]/i) && !r(/chrome\/18/i) && !i()) && C();
        C.mock_ = null;
          ...
          s = function (e, t) {
            ...
            return (
              u.forEach((i, s) => {
                ...
                const D = { begin: l, end: f, text: c, cueType: "chapters" };
            ...
            const n = (0, r.G3)(),
              i = e.reduce(function (e, t) {
                if (!t || !t.cueType || "chapters" === t.cueType) {
                  const r = new u.u({ time: t.begin, image: t.image });
        ...
        const s = i().clear,
          ...
          l = (e, t) => {
            ...
            for (let t = 0; t < e.length; t++) {
              ...
              if (null != u)
                for (n in r)
                  o(r, n) &&
                    ((i = a(n)), u.style[i] !== r[n] && (u.style[i] = r[n]));
            }
          },
          d = (e, t, n, r) => {
            n = n || "all-players";
          ...
          m = (e, t, n = !1) => {
            ...
            for (let t = 0; t < g.length; t++) {
              ...
              if (r.test.test(e))
                return (
                  (i = r.extract.exec(e).slice(1).map(r.map)),
      ...
      2799: (e, t, n) => {
        ...
        const s = (e, t) => e.classList.contains(t),
          ...
          E = (e, t, n) => {
            const r = s(e, t);
            (n = (0, u.jn)(n) ? n : !r) !== r && (n ? y(e, t) : F(e, t));
          },
          A = (e, t, n) => {
            e.setAttribute(t, n);
          },
      ...
      8494: (e, t, n) => {
        ...
        const v = Object.assign({}, i, u, r, {
          ...
          foreach: function (e, t) {
            for (const n in e) y(e, n) && t(n, e[n]);
          },
          flashVersion: d.dI,
          isIframe: d.cL,
          indexOf: l.cq,
      ...
      8762: (e, t, n) => {
        ...
        n.d(t, { Z: () => s });
        var r = n(1142);
        const u = { debug: 0, info: 100, warn: 200, error: 400 },
          i = (e) => {
            var t;
            switch (typeof e) {
              case "object":
      ...
      1569: (e, t, n) => {
        ...
        const i = function (e) {
          ...
          s = function (e) {
            ...
            return (
              !(u > i) &&
              !(u === i && parseFloat(`0${t[1]}`) > parseFloat(n[1]))
            );
          },
          a = function () {
            return o();
      ...
      5882: (e, t, n) => {
        ...
        const y = (e, t, n) => {
          ...
          E = (e, t, n, r, u = g) => {
            let i = e.handlers[t],
              o = e.options[t];
            if (
              (i || ((i = e.handlers[t] = {}), (o = e.options[t] = {})), i[n])
            )
          ...
          B = (e, t) => {
            if (
              (C || (C = new T(document).on("interaction")),
            ...
            E(e, t, "blur", () => {
              ...
              E(e, t, "focus", () => {
                C.event && C.event.type === h && (0, s.cn)(n, "jw-tab-focus");
              });
          },
          k = (e, t, n, r) => {
            c
              ? E(e, t, "pointerdown", n, r)
              : (l && E(e, t, "mousedown", n, r), E(e, t, "touchstart", n, r));
          },
          j = (e) => {
          ...
          S = (e) => {
            ...
            const { el: t, passive: n } = e,
              r = !!p && { passive: n },
              i = (t) => {
                if (e.dragged) y(e, u.Wp, t);
                else {
                  const { pageX: n, pageY: r } = P(t),
                    i = n - e.startX,
                    o = r - e.startY;
                  i * i + o * o > 36 &&
                    (y(e, u.nv, t), (e.dragged = !0), y(e, u.Wp, t));
                }
                var r;
                n ||
                  "touchmove" !== t.type ||
              ...
              o = (t) => {
                clearTimeout(m),
                  e.el &&
                    (A(e),
                    b(e, d),
                    e.dragged && ((e.dragged = !1), y(e, u.Sv, t)));
              };
            B(e, f),
              k(
                e,
                ...
                (u) => {
                  ...
                  if (
                    ...
                    "mousedown" === c
                      ? (E(e, d, "mousemove", i, r), E(e, d, "mouseup", o))
                      : "touchstart" === c &&
                        (E(e, d, "touchmove", i, r),
                        E(e, d, "touchcancel", o),
                        E(e, d, "touchend", o));
          ...
          O = {
            ...
            longPress(e) {
              ...
              if (r.OS.iOS) {
                ...
                E(e, t, "touchstart", (r) => {
                  ...
                  E(e, t, "touchcancel", n),
                  E(e, t, "touchend", n);
              } else e.el.oncontextmenu = (n) => (y(e, t, n), !1);
            },
            focus(e) {
              const t = "focus";
              E(e, t, t, (n) => {
            ...
            over(e) {
              (c || l) &&
                E(e, u.B1, c ? "pointerover" : "mouseover", (t) => {
            ...
            move(e) {
              (c || l) &&
                E(e, u.tP, c ? "pointermove" : "mousemove", (t) => {
            ...
            interaction(e) {
              ...
              E(e, t, "mousedown", n, !0), E(e, t, h, n, !0);
            },
            tap() {},
            doubleTap() {},
          },
        ...
        class T extends i.ZP {
          ...
          destroy() {
            this.el && (this.off(), c && A(this), (this.el = null));
          }
        }
      },
      6042: (e, t, n) => {
        ...
        const S = P.Date,
          ...
          M = function () {},
          $ = function (e, t, ...n) {
            if (E && e.bind === E) return E.apply(e, [t].concat(n));
          ...
          R = function (e, t, n, r) {
            ...
            if ((null == e && (e = []), h && e.reduce === h))
              return r && (t = $(t, r)), u ? e.reduce(t, n) : e.reduce(t);
            if (
              (k(e, function (e, i, o) {
        ...
        const te = function (e) {
              ...
              return (
                ...
                d <= 0
                  ? (clearTimeout(o),
                    ...
                    (i = e.apply(r, u)),
                    (r = u = null))
                  : o || !1 === n.trailing || (o = setTimeout(a, d)),
                i
              );
            };
          },
          ...
          we =
            ...
            function (e, ...t) {
              return (
                k(t, function (t) {
                  if (t) for (const n in t) u(t, n) && (e[n] = t[n]);
                }),
                e
              );
            },
      ...
      7034: (e, t, n) => {
        ...
        const i =
            (null == (r = window) || null == (u = r.location)
              ? void 0
              : u.protocol) || "",
          o = (e) => {
            switch (typeof e) {
      ...
      6601: (e, t, n) => {
        ...
        n.d(t, { i: () => r });
        const r =
          "8.36.6+commercial_master.607.@jwplayer/service-loader@2.0.0.ads-dai@mono.ads-freewheel@mono.ads-googima@mono.ads-vast@mono.hls.js@1.5.13.jwplayer@mono.jwplayer-ads-header-bidding@github:jwplayer/jwplayer-ads-header-bidding#v7.10.0.jwplayer-analytics@github:jwplayer/jwplayer-analytics#v4.0.9.plugin-gapro@mono";
      },
      4225: (e, t, n) => {
        "use strict";
        n.d(t, { Z: () => o });
        ...
        class c {
          constructor(e, t, n) {
            const r = {
              ...
              d = l.firstChild,
              f = l.nextSibling;
            (0, i.oB)([l, f], Object.assign({ overflow: "auto" }, r, s)),
              (0, i.oB)(c, Object.assign({}, r, s)),
          ...
          v = function (e, t) {
                ...
                (c = Object.assign(
                  {
                    ...
                    logo: { position: "control-bar", file: D() },
                  },
                  r.ke,
                  (0, i.ei)(c, [
                    "analytics",
            ...
            return (
              c.__abSendDomainToFeeds &&
                ((A = c.playlist), /\.jwplatform.com|\.jwplayer.com/.test(A)) &&
                (c.playlist =
                  (E = c.playlist) +
                  `${
                    -1 !== E.indexOf("?") ? "&" : "?"
                  }page_domain=${encodeURIComponent((0, h.X)())}`),
              c
            );
          };
      },
      6577: (e, t, n) => {
        ...
        function O(e) {
          ...
          r.tick("init"),
            ...
            Object.defineProperties(this, {
              ...
              plugins: { enumerable: !0, get: () => u },
              _qoe: { enumerable: !0, get: () => r },
              version: { enumerable: !0, get: () => D.i },
              Events: { enumerable: !0, get: () => y.ZP },
              utils: {
                enumerable: !0,
        ...
        const H = w.Z.logger.child("api/api-public"),
          ...
          ee = function (e) {
            const t = {};
            Y(this, e, e, t), Y(this, e, O.prototype, t);
          },
          te = window;
        Object.assign(I, U);
        const ne = function (e) {
      ...
      3487: (e, t, n) => {
        "use strict";
        n.d(t, { MK: () => r.MK, Nq: () => r.Nq, bX: () => u, sb: () => i });
        n(1569);
        var r = n(7164);
        const u = function (e) {
            let t = (0, r.bX)(e);
          ...
          i = (e) => {
            ...
            const n = {
              ...
              keepWatching:
                "//ssl.p.jwpcdn.com/player/v/8.36.6/keepWatching.js",
      ...
      2963: (e, t, n) => {
          ...
          h = (e) => {
            ...
            "boolean" != typeof (null == e ? void 0 : e.hlsjsdefault) ||
              ...
              "boolean" != typeof (null == e ? void 0 : e.androidhls) ||
                e.androidhls;
            return (
              (!u.OS.iPad || !u.Browser.chrome) &&
              !(t && u.Browser.safari && !n) &&
              (!t ||
                !u.OS.android ||
                !1 === e.androidhls ||
                !1 !== e.hlsjsdefault) &&
        ...
        (d.supports = D),
          r.B.push({ name: "shaka", supports: p }),
          r.B.unshift({ name: "hlsjs", supports: h });
        const g = r.B;
      },
      2303: (e, t, n) => {
        "use strict";
        ...
        const c = class {
          constructor(e) {
            (this.keyData = ((e) => {
              ...
              return { edition: t, token: n, expiration: o };
            })(e)),
        ...
        e.exports = (function () {
          ...
          S(S.S + S.F * (!!$ && 1 != $.length), "String", {
            fromCodePoint: function (e) {
              for (
                var t, n = arguments, r = [], u = arguments.length, i = 0;
                u > i;

              ) {
                if (((t = +n[i++]), L(t, 1114111) !== t))
          ...
          var R,
            ...
            re = function (e, t) {
              ...
              return "function" == typeof t ? ue({ "": Q }, "", t) : Q;
            };
          function ue(e, t, n) {
            var r = e[t];
          ...
          function oe() {
            if (R[U]) return String.fromCodePoint(R.codePointAt(U));
          }
          function se() {
            var e = oe();
            return (
              "\n" === e ? (q++, (H = 0)) : e ? (H += e.length) : H++,
              e && (U += e.length),
              e
            );
          }
          var ae = {
            default: function () {
              switch (ee) {
                ...
                case "\u2029":
                  return void se();
                case "/":
                  return se(), void (W = "comment");
                case void 0:
                  return se(), ce("eof");
              }
              if (!ne.isSpaceSeparator(ee)) return ae[V]();
              se();
            },
            comment: function () {
              switch (ee) {
                case "*":
                  return se(), void (W = "multiLineComment");
                case "/":
                  return se(), void (W = "singleLineComment");
              }
              throw me(se());
            },
            multiLineComment: function () {
              switch (ee) {
                case "*":
                  return se(), void (W = "multiLineCommentAsterisk");
                case void 0:
                  throw me(se());
              }
              se();
            ...
            multiLineCommentAsterisk: function () {
              switch (ee) {
                case "*":
                  return void se();
                case "/":
                  return se(), void (W = "default");
                case void 0:
                  throw me(se());
              }
              se(), (W = "multiLineComment");
            },
            ...
            value: function () {
              switch (ee) {
                ...
                case "-":
                case "+":
                  return "-" === se() && (Y = -1), void (W = "sign");
                case ".":
                  return (X = se()), void (W = "decimalPointLeading");
                case "0":
                  return (X = se()), void (W = "zero");
                case "1":
                case "2":
                case "3":
                case "4":
                ...
                case "8":
                case "9":
                  return (X = se()), void (W = "decimalInteger");
                case "I":
            ...
            identifierNameStartEscape: function () {
              ...
              switch (e) {
                ...
                case "_":
                  break;
                default:
                  if (!ne.isIdStartChar(e)) throw ye();
              }
              (X += e), (W = "identifierName");
            },
            identifierName: function () {
              switch (ee) {
                ...
                case "‍":
                  return void (X += se());
                case "\\":
                  return se(), void (W = "identifierNameEscape");
              }
              if (!ne.isIdContinueChar(ee)) return ce("identifier", X);
              X += se();
            },
            identifierNameEscape: function () {
              ...
              switch (e) {
                ...
                case "‍":
                  break;
                default:
                  if (!ne.isIdContinueChar(e)) throw ye();
              }
              (X += e), (W = "identifierName");
            },
            sign: function () {
            ...
            zero: function () {
              switch (ee) {
                case ".":
                  return (X += se()), void (W = "decimalPoint");
                case "e":
                case "E":
                  return (X += se()), void (W = "decimalExponent");
                case "x":
                case "X":
                  return (X += se()), void (W = "hexadecimal");
              }
            ...
            decimalInteger: function () {
              ...
              if (!ne.isDigit(ee)) return ce("numeric", Y * Number(X));
              X += se();
            },
            decimalPointLeading: function () {
              if (ne.isDigit(ee))
                return (X += se()), void (W = "decimalFraction");
              throw me(se());
            },
            decimalPoint: function () {
              ...
              return ne.isDigit(ee)
                ? ((X += se()), void (W = "decimalFraction"))
            ...
            decimalExponent: function () {
              switch (ee) {
                case "+":
                case "-":
                  return (X += se()), void (W = "decimalExponentSign");
              }
              if (ne.isDigit(ee))
                return (X += se()), void (W = "decimalExponentInteger");
              throw me(se());
            },
            ...
            hexadecimal: function () {
              if (ne.isHexDigit(ee))
                return (X += se()), void (W = "hexadecimalInteger");
              throw me(se());
            },
            hexadecimalInteger: function () {
              if (!ne.isHexDigit(ee)) return ce("numeric", Y * Number(X));
              X += se();
            },
            string: function () {
              switch (ee) {
            ...
            beforePropertyName: function () {
              switch (ee) {
                case "$":
                case "_":
                  return (X = se()), void (W = "identifierName");
                case "\\":
                  return se(), void (W = "identifierNameStartEscape");
                case "}":
                  return ce("punctuator", se());
                case '"':
                case "'":
                  return (J = '"' === se()), void (W = "string");
              }
          ...
          function ce(e, t) {
            return { type: e, value: t, line: q, column: H };
          }
          function le(e) {
          ...
          var he = {
            ...
            beforePropertyName: function () {
              switch (G.type) {
                case "identifier":
                case "string":
                  return (K = G.value), void (V = "afterPropertyName");
                case "punctuator":
                  return void ge();
                case "eof":
                  throw Ce();
          ...
          function me(e) {
            return Ee(
              void 0 === e
                ? "JSON5: invalid end of input at " + q + ":" + H
                : "JSON5: invalid character '" + ve(e) + "' at " + q + ":" + H
            );
          }
          function Ce() {
          ...
          function ye() {
            return Ee(
              "JSON5: invalid identifier character at " + q + ":" + (H -= 5)
            );
          }
          function Fe(e) {
            console.warn(
          ...
          return {
            ...
            stringify: function (e, t, n) {
              ...
              return (
                ...
                "number" == typeof n
                  ? n > 0 &&
                    ...
                    (a = "          ".substr(0, n)))
                  : "string" == typeof n && (a = n.substr(0, 10)),
                D("", { "": e })
              );
              function D(e, t) {
                var n = t[e];
              ...
              function p(e) {
                ...
                s += a;
                for (
                  var n, u, i = [], c = 0, l = r || Object.keys(e);
                  c < l.length;
                  c += 1
                ) {
                  var d = l[c],
              ...
              function g(e) {
                ...
                for (var n = t.length; n < e.length; n++)
                  if (
                    !ne.isIdContinueChar(String.fromCodePoint(e.codePointAt(n)))
                  )
                    return h(e, !0);
                return e;
              }
          ...
          function r(e, n) {
            try {
              ...
              if (n && ("object" == typeof n || "function" == typeof n)) {
                var r = n.then;
                if (n instanceof t)
                  return (e._state = 3), (e._value = n), void i(e);
                if ("function" == typeof r)
                  return void o(
                    (function (e, t) {
                      return function () {
      ...
      9563: (e) => {
        ...
        e.exports = {
            ...
            !(function (e, t) {
              for (var n = 0; n < t.length; n++) {
                ...
                if (i) {
                  ...
                  (r[e] = r[e] || {}), (r[e][u.id] = { id: u.id, parts: a });
                }
              }
            })(
              t,
          ...
          clear: function (e, t) {
            ...
            if (t) {
              var u = n[t];
              if (u) for (var i = 0; i < u.parts.length; i += 1) u.parts[i]();
              return;
            }

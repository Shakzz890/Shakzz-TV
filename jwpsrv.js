!(function () {
  ...
  function q(e) {
    var a,
      t = (window.jwplayer && window.jwplayer.defaults) || {},
      n = e.related,
      r = {
        ...
        advertisingBlockType:
          ((a = e), a.advertising ? (a.advertising.outstream ? L : O) : N),
    ...
    return (
      e.autostart in E && (r.autostartConfig = E[e.autostart]),
      n && (r.relatedPluginFeedFile = n.recommendations || n.file),
      r
    );
  }
  var F = { UNKNOWN: 999, IAB: 0 },
    U = { noBid: 0, bid: 1, timeout: 2, invalid: 3, abort: 4, error: 5 },
    _ = {
      numCompanions: -1,
      podCount: 0,
      podIndex: 0,
    ...
    J = { dfp: 0, jwp: 1, jwpdfp: 2, jwpspotx: 3 },
    X = [
      "id",
      "type",
      "pubid",
  ...
  var _e = {
    ...
    ze = {
      fed: function (e) {
        return -1 !== Qe.indexOf(e.meta.lastEvent)
          ? e.related.feedId
          : pe(e.playlistItemData.item);
      },
      fid: function (e) {
        return -1 !== Qe.indexOf(e.meta.lastEvent)
          ? e.related.feedInstanceId
          : fe(e.playlistItemData.item);
      },
      ft: function (e) {
  ...
  var He = { aes: 1, widevine: 2, playready: 3, fairplay: 4 };
  var $e = {
    interaction: 1,
    autostart: 2,
    repeat: 3,
  ...
  var Je = { none: 1, metadata: 2, auto: 3 };
  function Xe(e) {
    return e === 1 / 0
      ? 1 / 0
      : (e |= 0) <= 0
  ...
  (ea.st = function (e) {
    ...
    (ea.drm = function (e) {
      return (
        ((a = e.playlistItemData.drm) ? He[a] || 999 : 0) ||
  ...
  (na.pd = function (e) {
    return (a = e.playlistItemData.item), (t = a.preload), Je[t] || 0;
    var a, t;
  }),
    (na.vrt = function (e) {
      return (function (e) {
    ...
    (na.pr = function (e) {
      return (a = e.playlistItemData.playReason), $e[a] || 0;
      var a;
    }),
    (na.psd = function (e) {
      return -1 !== Qe.indexOf(e.meta.lastEvent)
        ? e.related.pinSetId
        : me(e.playlistItemData.item);
    }),
    (na.vh = function (e) {
  ...
  var da = function (e, a) {
    ...
    ua = (function () {
      function r(e, a, t, n) {
        da(this, r),
          ...
          (this.host = n),
          (this.paramData = ee({}, t)),
          h in this.paramData || (this.paramData[h] = { code: h, value: e }),
          b in this.paramData ||
            (this.paramData[b] = {
              code: b,
    ...
    pa = ["rtp"],
    fa = function (e) {
      return (e.paramData.tp = { code: "tp", value: 1 }), le(e.url);
    },
    ma = function (e, a, t, n) {
      var r = le("&tp=1"),
        i = new ua(e, a, t, ca[n]),
      ...
      for (c = u ? c : c[Symbol.iterator](); ; ) {
        ...
        if (
          "rtp" === p &&
          p in i.paramData &&
          (delete i.paramData.rtp.value.decisionThresholds, (o = fa(i)) <= 8192)
        )
          return i.url;
      }
      var f = l,
      ...
      for (f = m ? f : f[Symbol.iterator](); ; ) {
        ...
        if (i.paramData[y]) {
          var b = o - 8192 + ("tp" in i.paramData ? 0 : r),
            ...
            k = sa(h),
            D = k ? le(k) : 0;
          if ((delete i.paramData[y], D <= b)) o = fa(i);
          else {
            for (
              var w = { code: y, value: h.value },
                I = D - b,
                S = Math.max(20, Math.floor(w.value.length / 10)),
                T = Math.ceil(w.value.length / S),
                P = 1;
              P <= T;
              P++
            ) {
            ...
            if ((o = fa(i)) <= 8192) return i.url;
          }
        }
      }
      return "main" === n && (i.host = ca.main_fallback), i.url;
    },
    va = function (e) {
  ...
  function ga(e) {
    var a,
      t,
      n = e.external && e.external.playerAPI,
      r =
        "complete" ===
        (
          ((t = (a = n) && a.getContainer && a.getContainer()) &&
            t.ownerDocument) ||
          window.document
        ).readyState;
    (e.trackingState.pageLoaded = r) ||
      ((e.trackingState.boundFlushQueue = va.bind(null, e)),
  ...
  var ha = { delaySend: !1, returnURL: !1 };
  function ka(t, e) {
    var a =
    ...
    if (
      ...
      return n.delaySend
        ? ya.bind(null, t, o)
        : n.returnURL
        ? ma(o.event, o.bucket, o.parameters, o.pingDestination)
        : void ya(t, o);
    }
  }
  function Da(e) {
    ...
    e.bidders.forEach(function (e) {
      ...
      (r[a.toLowerCase()] =
        ...
        X.forEach(function (e) {
          ...
          "result" === e
            ? (n.result = U[t[e]])
            : ee(n, void 0 !== t[e] ? (((a = {})[e] = t[e]), a) : void 0),
            t.code &&
  ...
  function wa(t, e) {
    ...
    if (
      ((a =
        "googima" === e.client
          ? ((n.creativeId = ie(e, "ima.ad.g.creativeId")),
            ie(e, "ima.ad.g.mediaUrl"))
          : ((n.creativeId = ie(e, "creativeId")), ie(e, "mediafile.file"))),
  ...
  function Ea(e, a) {
    ...
    n > t.previousQuartile &&
      (wa(e, a), ka(e, "v", "clienta"), (t.previousQuartile = n));
  }
  var Ca = {
    adComplete: function (e, a) {
      (e.ads.currentQuartile = 4), Ea(e, a);
    },
    ...
    adTime: function (e, a) {
      ...
      !n ||
        ...
        (!(function (e, a, t) {
          var n = Pa(a, t),
            r =
              e.ads.pingLimiters.visibleEvent.canSendPing(S) ||
              e.ads.pingLimiters.visibleEvent.canSendPing(I);
        ...
        i.visibleEvent.canSendPing(S) &&
          r.totalVisibleSeconds >= Math.floor(t.duration / 2) &&
          (ka(e, S, "clienta"), i.visibleEvent.setPingSent(S)),
        i.visibleEvent.canSendPing(I) &&
          2 <= r.maxConsecutiveVisibleSeconds &&
          (ka(e, I, "clienta"), i.visibleEvent.setPingSent(I)),
  ...
  function Aa(o) {
    ...
    e.on($.join(" "), function () {
      Ta(o, "ad-break"),
        o.ads.adBreakTracking &&
          o.ads.adBreakTracking.shouldTrack &&
          ((o.ads.adBreakTracking.shouldTrack = !1),
      ...
      e.on(
        ...
        function (e) {
          ...
          if (
            "adImpression" === e.type ||
            (null === (a = o.configData) || void 0 === a
              ? void 0
              : a.advertisingBlockType) !== L
          ) {
            var t,
              n,
              r,
            ...
            (t = i),
              "adClick" === (n = e).type ||
                (t && t.adId === n.id && -1 !== n.id) ||
                ((o.ads.adEventData = ee({ adId: e.id }, _)),
              ...
              e.type in Ca
                ? Ca[e.type](o, e)
                : -1 === W.indexOf(e.type) && ka(o, K[e.type], "clienta");
          }
        }
      );
  }
  function xa(e) {
    ...
    "function" == typeof navigator.sendBeacon &&
      (a = e).external.playerAPI.on("remove", function () {
        Me(a, f), (a.meta.playerRemoved = !0), ka(a, f, "jwplayer6");
      });
  }
  function ja() {
    try {
  ...
  var Ba = "clickCard",
    ...
    La = "showCard",
    Oa = "time",
    Na = { showCard: "sh", hideCard: "hd", clickCard: "cl" },
    qa = { time: "t", nonTime: "nt" };
  function Fa(f, m) {
    return function (e) {
      var a,
        t,
  ...
  function Ua(t) {
    t.external.playerAPI.on("ready", function () {
      var e, a;
      (a = (e = t).external.playerAPI.getPlugin("interactive")) &&
        a.on &&
        (a.on(La, Fa(La, e)),
        a.on(Ma, Fa(Ma, e)),
        a.on(Ba, Fa(Ba, e)),
  ...
  var Ka = a,
    ...
    Ha = j;
  function $a(e) {
    e.meta.playbackTracking.playItemCount++, ka(e, "s");
  }
  function Ja(u, s) {
    return function (e) {
      ...
      if (((a[s] = e), s === Wa)) {
        ...
        var c = Ae(r);
        (n.previousTime = c), (n.currentPosition = c);
      }
      s === Ha &&
        (Me(u, p),
        "flash_adaptive" === je(r)
          ? !u.meta.playbackSent &&
            n.segmentReceived &&
            ((u.meta.playbackSent = !0), (n.segmentReceived = !1), $a(u))
          : u.meta.playbackSent || ((u.meta.playbackSent = !0), $a(u)));
    };
  }
  function Xa(e) {
    ...
    var d = (r + 0.5) | 0;
    (a.audibleElapsedSeconds = d), 0 < i && ka(e, l);
  }
  function Ya(e, a, t, n) {
    a < n &&
      n <= a + t &&
      ((e.meta.playbackTracking.retTimeWatched = n), ka(e, "ret"));
  }
  function Za(e, a, t) {
    var n,
      r,
    ...
    i
      ? (function (e) {
          ...
          if (za(a)) {
            ...
            var t = ka(e, "vs", "jwplayer6", { delaySend: !0 });
      ...
      : ((t = e.meta.seekTracking),
        (n = a),
        (r = o),
        za(t) || ((t.videoStartDragTime = r), (t.dragStartTime = Date.now())),
        t.numTrackedSeeks++,
  ...
  function at(e, a, t) {
    ...
    (e.playerData.lastErrorCode[a] = t.code),
      ...
      e.errors.numberEventsSent < e.errors.NUM_ERRORS_PER_SESSION &&
        ...
        ((e.errors.numberEventsSent += 1), ka(e, a, i));
  }
  var tt = j,
    nt = x,
    rt = a,
  ...
  function dt(v) {
    var e,
      ...
      t = function (e, a) {
        ...
        t &&
          t === ge(a.item) &&
          ((e.playerData.lastErrorCode[o] = a.code), ka(e, "paf", "error"));
      }.bind(null, v);
    g.on("idle buffer play pause complete error", function (e) {
      ...
      g.on("playlistItem", function (e) {
        ...
        var t,
          n,
          r = e.item || xe(g);
        r && ((a.mediaId = ge(r)), he(v, r)),
          a.ready &&
            ((v.meta.playbackTracking.posterVideoThumbnail = be(e.item)),
            (t = v),
            (n = a.ready),
          ...
          if (v.meta.seekTracking.dragStartTime) t.previousTime = n;
            ...
            if (
              ...
              !0 === t.sendSetTimeEvents &&
                (Za(v, n, 3), Za(v, n, 10), Za(v, n, 30)),
              r <= 0 || r === 1 / 0)
            )
              t.playedSeconds >= G && ((t.latency = e.latency), Xa(v));
            else if (c === t.trackingSegment + 1) {
              var m = (R * t.trackingSegment) / l;
              if (l < c) return;
              (t.normalizedTime = m), Xa(v), (t.trackingSegment = 0);
            }
          }
      }),
      ...
      g.on("complete", function () {
        ...
        if (!(a <= 0 || a === 1 / 0)) {
          Xe(a);
          (e.normalizedTime = R), Xa(v), (e.playedSecondsTotal = 0);
        }
      }),
          ...
          e.on("nextShown", function (e) {
            (a.related.nextShownReason = e.reason),
              ...
              ("hover" !== e.reason || a.related.sendHoverPing) &&
                ((a.related.sendHoverPing = !1), ct(a, e, c));
          }),
        ...
        if (e.getPlugin) {
          ...
          t &&
            t.on("click", function (e) {
              (a.sharing.shareMethod = pt[e.method] || pt.custom), ka(a, r);
            });
        }
      })(e);
    });
  ...
  function yt(e, a) {
    var t =
      2 < arguments.length && void 0 !== arguments[2] ? arguments[2] : window;
    if (e) return { pageViewId: gt };
    var n,
      r,
      i = t.document,
      o = t.top,
      ...
      s = i.querySelector('meta[property="og:title"]'),
      p = void 0;
    return (
      s && (p = s.getAttribute("content")),
      {
        ...
        testCaseId: a
          ...
          : void 0,
        amp: u.amp,
        jwAmpComponent: ((r = i.location.search), /isAMP/.test(r)),
      }
    );
  }
  var bt = void 0;
  ...
  function It(e, a, t) {
    var n,
      r,
      i = a.sdkplatform ? parseInt(a.sdkplatform, 10) : M,
      o = e.getConfig(),
      d = (o || {}).advertising || {},
      l = (wt += 1),
      c = (function () {
        var e =
            0 < arguments.length && void 0 !== arguments[0]
              ...
              : window,
          a = e.navigator;
        return "doNotTrack" in a || "doNotTrack" in e || "msDoNotTrack" in a
          ? a.doNotTrack || e.doNotTrack || a.msDoNotTrack
          : "unsupported";
      })(),
      u = Dt(c, o.doNotSaveCookies),
      s = void 0,
      p = void 0;
    if (u) bt && bt.removeItem("jwplayerLocalId");
    else {
      var f = (function () {
        if (!bt) return { localID: null, storageAvailable: "fail" };
        var e = bt.jwplayerLocalId;
        if (e) return { localID: e, storageAvailable: "read" };
        try {
          return (
            (bt.jwplayerLocalId = Ra(12)),
            { localID: bt.jwplayerLocalId, storageAvailable: "set" }
          );
        } catch (e) {
          return { localID: null, storageAvailable: "fail" };
        }
      })();
      (s = f.localID), (p = f.storageAvailable);
    }
    var m = (function () {
        var e = (
          0 < arguments.length && void 0 !== arguments[0]
      ...
      g = (function () {
        var e =
          0 < arguments.length && void 0 !== arguments[0]
            ...
            : window;
        try {
          if (e.top !== e.self) return e.top.document.referrer;
        } catch (e) {
          return null;
        }
    ...
    return {
      ...
      playerData: {
        ...
        floatingConfigured: !(
          null === (n = o.setupConfig) ||
          void 0 === n ||
          !n.floating ||
          (null === (r = o.setupConfig) || void 0 === r
            ? void 0
            : r.floating.disabled)
        ),
        ...
        localization: {
          language: o.language,
          numIntlKeys:
            "object" == typeof o.intl ? Object.keys(o.intl).length : null,
          numLocalKeys:
            "object" == typeof o.localization
              ? Object.keys(o.localization).length
              : null,
        },
      ...
      staticPlayerData:
        ...
        (S = i),
        (P = {
          playerVersion: ((T = w.version), T.split("+")[0]),
          sdkPlatform: I.sdkplatform || M,
          embedID: Ra(12),
        }),
        S &&
          ((P.sdkVersion = I.iossdkversion),
      ...
      browser: {
        ...
        isPageStandalone: v,
        docReferrer: g,
        storage: { localID: s, storageAvailable: p, doNotTrackProperty: c },
        pageData: yt(i, !1),
        doNotTrackUser: u,
      },
      meta: {
        debug: !0 === a.debug,
        doNotPingBackIDs: ((h = o), !0 === h.doNotTrackCookies),
        setupCount: wt,
        nthPlayer: l,
        playbackEvents: {},
        playbackSent: void 0,
        ...
        playerRemoved: !1,
        pingLimiters: { playlistItem: new ht() },
        sessionSampled: E,
      },
      playlistItemData: {
        ready: void 0,
      ...
      ads: {
        ...
        pingLimiters: { visibleEvent: new ht() },
      },
      errors: {
        SAMPLE_RATE: 0.02,
      ...
      xa((n = i)),
        ...
        (this.getTrackingPixelURLs =
          ...
          function (e, a) {
            ...
            var t = ka(r, "vci", "clienta", { returnURL: !0 }),
              n = ka(r, "vcae", "clienta", { returnURL: !0 });
            return (
